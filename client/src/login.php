...
if (isset($_REQUEST["submit"])) {
    $email = $_POST['mail'];  // Utiliser l'email pour l'authentification
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            // Redirige vers la page en fonction du rôle
            if ($row['role'] == 'admin') {
                header("Location: admin_dashboard.php");  // Rediriger vers le tableau de bord de l'admin
            } elseif ($row['role'] == 'supermarché') {
                header("Location: supermarket_dashboard.php");  // Rediriger vers le tableau de bord du supermarché
            } else {
                header("Location: index.php?pg=home");  // Rediriger vers le tableau de bord du client
            }
            exit();
        } else {
    ...
    <div class="boite_principale">
        ...
        <div class="section_B">
            <form class="formulaire" method="POST" action="index.php?pg=login">
                <h2>Bon retour!</h2>
                <p class="description">replonger tout de suite dans votre aventure!</p>

                <fieldset class="Produit">
                    <legend>Login</legend>
                    <nav class="bloc1" style="transition:.5s;"> <br>
                        <label class="id">
                            Email <br>
                        ...
                        <br>
                        <p><a href="index.php?pg=forget" style="color:#ff66b2">Mot de passe oublier?</a></p>
                        <h5>Je n'ai pas de compte ! <a href="index.php?pg=signin" style="color:#ff66b2">Je m'inscris Maintenant</a></h5>
                    </nav>
                </fieldset>
